...
- solver tests fail 143 out of 400
- - 109 with ValueError: too many values to unpack (expected 2)
- - 6 with TypeError(s)
- - 1 with RuntimeError: generator raised StopIteration
- - 26 others that failed asserts 
